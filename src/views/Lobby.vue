  ...
  <v-container fill-height fluid black class="container">
    ...
    >
      ...
      >
        <!-- contents here-->
        <div
          class="v-image v-responsive blue-border theme--light mainLobbyContainer"
        >
          <div class="liveStreamContainer">
            <iframe
              src="https://vimeo.com/event/818966/embed/1815aa46b8?autoplay=1"
              frameborder="0"
