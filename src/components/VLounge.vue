  ...
  <v-container fill-height fluid black class="container">
    ...
    >
      ...
      >
        ...
        <v-btn><span><a href="HTTPS://MEET.GOOGLE.COM/XAG-HKWX-QGF" target="_blank" class="link">HTTPS://MEET.GOOGLE.COM/XAG-HKWX-QGF</a></span></v-btn>
      </div>
    </div>
  </v-container>
</template>
...
.team-border {
  background-image: url('~@/assets/border.png') !important;
