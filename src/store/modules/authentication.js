...
export default {
  ...
  mutations: {
    ...
    CLEAR_USER(state) {
      ...
      localStorage.removeItem('finishQuestion')
      localStorage.removeItem('trackpad')
      localStorage.removeItem('firstLoadNetwork')
      localStorage.removeItem('firstLoadExhibit')
      localStorage.removeItem('5min_mark')
      localStorage.removeItem('2min_mark')
      state.user = null
    }
  },
